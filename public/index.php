...
$router->register('/evaluations/types/edit/{id}', 'ParamTypeEvaluationController', 'edit');
$router->register('/evaluations/types/update', 'ParamTypeEvaluationController', 'update');
$router->register('/evaluations/types/update/{id}', 'ParamTypeEvaluationController', 'update');
$router->register('/evaluations/types/toggle', 'ParamTypeEvaluationController', 'toggle');
$router->register('/evaluations/types/toggle/{id}', 'ParamTypeEvaluationController', 'toggle');
...
$router->register('/evaluations/settings/edit/{id}', 'ParametresEvaluationController', 'edit');
$router->register('/evaluations/settings/update', 'ParametresEvaluationController', 'update');
$router->register('/evaluations/settings/update/{id}', 'ParametresEvaluationController', 'update');
$router->register('/evaluations/settings/delete', 'ParametresEvaluationController', 'delete');
$router->register('/evaluations/settings/delete/{id}', 'ParametresEvaluationController', 'delete');
