            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5><?= _("Configuration des Compositions pour l'Année en Cours") ?></h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="alert alert-info">
                            <?= _("Ces paramètres s'appliquent à toute l'école pour l'année académique active.") ?>
                        </div>

                        <form action="/param-composition/update" method="POST">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label for="nombre_composition_par_sequence" class="form-label"><?= _('Nombre de compositions autorisées par séquence') ?></label>
                                ...
                                <div class="col-md-6">
                                    <label for="note_maximale" class="form-label"><?= _('Note maximale pour une composition') ?></label>
