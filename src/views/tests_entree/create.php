...
<div class="max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold mb-2">Enregistrer un Test d'Entrée</h2>
        ...
        <form action="/tests_entree/store" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label for="classe_visee_id" class="block text-gray-700 text-sm font-bold mb-2">Classe Visée</label>
                ...
                <div>
                    <label for="date_test" class="block text-gray-700 text-sm font-bold mb-2">Date du Test</label>
            ...
            <div class="mt-8 flex justify-end gap-4">
                <a href="/tests_entree?eleve_id=<?= $eleve['id_eleve'] ?>" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Annuler</a>
