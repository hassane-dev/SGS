                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10"><?= _('Gestion du personnel') ?></h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/home"><?= _('Tableau de Bord') ?></a></li>
                            <li class="breadcrumb-item" aria-current="page"><?= _('Personnel') ?></li>
                        </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <?php else: ?>
                                        <?php foreach ($users as $user): ?>
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <a href="/drh/show?id=<?= $user['id_user'] ?>" class="btn btn-sm btn-info"><?= _('Voir') ?></a>
                                                    <?php if (Auth::get('id_user') != $user['id_user']): ?>
                                                        <a href="/drh/edit?id=<?= $user['id_user'] ?>" class="btn btn-sm btn-primary ms-2"><?= _('Modifier') ?></a>
