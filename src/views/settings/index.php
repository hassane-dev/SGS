...
<div class="max-w-4xl mx-auto">
    <h2 class="text-2xl font-bold mb-6"><?= _('General Settings') ?></h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="type_lycee" id="type_lycee" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
                        ...
                        <option value="prive" <?= ($settings['type_lycee'] ?? '') === 'prive' ? 'selected' : '' ?>><?= _('Private') ?></option>
                ...
                <!-- Nombre de devoirs -->
                <div>
                    <label for="nombre_devoirs_par_trimestre" class="block text-gray-700 text-sm font-bold mb-2"><?= _('Homework per Term') ?></label>
                ...
                <div class="md:col-span-2">
                    <label for="modalite_paiement" class="block text-gray-700 text-sm font-bold mb-2"><?= _('Payment Method') ?></label>
                    <select name="modalite_paiement" id="modalite_paiement" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
                        <option value="avant_inscription" <?= ($settings['modalite_paiement'] ?? '') === 'avant_inscription' ? 'selected' : '' ?>><?= _('Before registration') ?></option>
                        <option value="apres_test" <?= ($settings['modalite_paiement'] ?? '') === 'apres_test' ? 'selected' : '' ?>><?= _('After entrance test') ?></option>
                        <option value="fractionne" <?= ($settings['modalite_paiement'] ?? '') === 'fractionne' ? 'selected' : '' ?>><?= _('Installments') ?></option>
                    </select>
                </div>
                ...
                <div class="md:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-gray-700"><?= _('Multilingual') ?></span>
                    </label>
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-gray-700"><?= _('Biometrics') ?></span>
                    </label>
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-gray-700"><?= _('National Privacy') ?></span>
                    </label>
                </div>
            </div>
