            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label for="nomEcole">Nom officiel du lycée</label>
                        <input type="text" id="nomEcole" name="nomEcole" class="form-control" value="<?= htmlspecialchars($params['nomEcole']) ?>">
                    </div>
                    <div class="col-md-6 form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input type="text" id="boitePostale" name="boitePostale" class="form-control" value="<?= htmlspecialchars($params['boitePostale']) ?>">
                    </div>
                </div>
                 <div class="row">
                    <div class="col-md-6 form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <select id="typeLycee" name="typeLycee" class="form-control">
                            <option value="public" <?= $params['typeLycee'] == 'public' ? 'selected' : '' ?>>Public</option>
                            <option value="prive" <?= $params['typeLycee'] == 'prive' ? 'selected' : '' ?>>Privé</option>
                            <option value="semi-public" <?= $params['typeLycee'] == 'semi-public' ? 'selected' : '' ?>>Semi-public</option>
                        </select>
                    </div>
                </div>
                <div class="form-group form-check">
                    <input type="checkbox" id="boutique" name="boutique" class="form-check-input" value="1" <?= $params['boutique'] ? 'checked' : '' ?>>
