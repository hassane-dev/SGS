...
<div class="max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold mb-6"><?= _('Edit Student File') ?></h2>
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg">
        <form action="/eleves/update" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label for="photo" class="block text-gray-700 text-sm font-bold mb-2"><?= _('Change Photo') ?></label>
                    <?php if (!empty($eleve['photo'])): ?>
                        <div class="mb-2">
                            <img src="<?= htmlspecialchars($eleve['photo']) ?>" alt="<?= _('Current Photo') ?>" class="h-20 w-20 rounded-full object-cover">
                        </div>
                    <?php endif; ?>
