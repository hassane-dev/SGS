                                        ...
                                        <?php foreach ($eleves as $eleve): ?>
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <a href="/eleves/parcours-academique?id=<?= $eleve['id_eleve'] ?>" class="btn btn-light-warning btn-sm ms-2" title="<?= _('Suivi & Parcours Scolaire') ?>"><i class="ph-duotone ph-chart-line-up"></i></a>
