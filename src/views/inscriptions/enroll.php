...
<div class="max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold mb-2">Inscrire un Élève</h2>
    <p class="text-lg text-gray-600 mb-6">Élève: <span class="font-semibold"><?= htmlspecialchars($eleve['prenom'] . ' ' . $eleve['nom']) ?></span></p>
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg">
        <form action="/inscriptions/enroll" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    <label for="classe_id" class="block text-gray-700 text-sm font-bold mb-2">Classe</label>
                ...
                <div>
                     <label class="flex items-center">
                        ...
                        <span class="ml-2 text-gray-700">Activer l'inscription immédiatement</span>
                    </label>
                    <p class="text-xs text-gray-600 mt-1">L'inscription doit être activée pour que l'élève apparaisse dans les listes de classe pour les notes, etc.</p>
                </div>
