    ...
    <div class="pc-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="page-header-title">
                            <h2 class="mb-0"><?= _('Configuration des Centres de Coûts') ?></h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h5><?= _('Ajouter un Centre de Coût') ?></h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5><?= _('Centres de Coûts Existants') ?></h5>
                    </div>
                            ...
                            <table class="table table-hover table-striped mb-0">
                                ...
                                <tbody>
                                    <?php if (empty($centres)): ?>
                                        <tr>
                                            <td colspan="5" class="text-center text-muted py-4"><?= _('Aucun centre de coût configuré.') ?></td>
                                        </tr>
                                    <?php else: ?>
                                        <?php foreach ($centres as $c): ?>
                                            <tr>
                                                <td><?= htmlspecialchars($c['id']) ?></td>
                                                <td><strong><?= htmlspecialchars($c['nom_centre']) ?></strong></td>
