                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="page-header-title">
                            <h2 class="mb-0"><?= _('Dépenses en attente de Validation') ?></h2>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php if (empty($depenses)): ?>
                                <tr>
                                    <td colspan="6" class="text-center text-muted py-4"><?= _('Aucune demande de dépense en attente de validation.') ?></td>
                                </tr>
                            <?php else: ?>
                                <?php foreach ($depenses as $d): ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/depenses/validate/<?= $d['id'] ?>" class="btn btn-sm btn-primary">
                                                <i class="ti ti-shield-check"></i> <?= _('Valider/Voter') ?>
                                            </a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
