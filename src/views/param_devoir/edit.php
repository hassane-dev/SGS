    ...
    <form action="/param-devoir/update" method="POST">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Configuration des Devoirs pour l'Année en Cours</h6>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label for="nombreDevoirParSequence">Nombre de devoirs autorisés par séquence</label>
                        <input type="number" id="nombreDevoirParSequence" name="nombreDevoirParSequence" class="form-control" value="<?= htmlspecialchars($params['nombreDevoirParSequence']) ?>">
                    </div>
                    <div class="col-md-6 form-group">
                        <label for="noteMaximale">Note maximale pour un devoir</label>
