    ...
    <div class="pc-content">
        ...
        <div class="card">
            <div class="card-body text-center p-5">
                <i class="ph-duotone ph-clock-counter-clockwise fs-1 text-muted mb-3"></i>
                <h5>Interface en cours de développement</h5>
                <p class="text-muted">L'historique complet des transactions sera bientôt disponible ici.</p>
