    ...
    <div class="pc-content">
        ...
        <div class="card">
            <div class="card-body text-center p-5">
                <i class="ph-duotone ph-file-text fs-1 text-muted mb-3"></i>
                <h5>Interface en cours de développement</h5>
                <p class="text-muted">Les rapports financiers détaillés (journal de caisse, balances) seront bientôt disponibles ici.</p>
