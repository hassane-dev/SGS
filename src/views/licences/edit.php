...
<div class="max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold mb-6"><?= _('Edit License') ?></h2>
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg">
        <form action="/licences/update" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="duree_mois" class="block text-gray-700 text-sm font-bold mb-2"><?= _('Duration (in months)') ?></label>
                    <select name="duree_mois" id="duree_mois" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" required>
                        <option value="3" <?= $licence['duree_mois'] == 3 ? 'selected' : '' ?>><?= _('3 months') ?></option>
                        <option value="6" <?= $licence['duree_mois'] == 6 ? 'selected' : '' ?>><?= _('6 months') ?></option>
                        <option value="12" <?= $licence['duree_mois'] == 12 ? 'selected' : '' ?>><?= _('1 year') ?></option>
                    </select>
                </div>

                <div>
                    <label for="date_debut" class="block text-gray-700 text-sm font-bold mb-2"><?= _('Start Date') ?></label>
                ...
                <div class="md:col-span-2">
                     <label class="flex items-center">
                        ...
                        <span class="ml-2 text-gray-700"><?= _('License Active') ?></span>
                    </label>
                </div>
            ...
            <div class="mt-8 flex justify-end gap-4">
                <a href="/licences" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded"><?= _('Cancel') ?></a>
