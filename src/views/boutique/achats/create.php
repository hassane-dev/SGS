...
<div class="max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold mb-2"><?= _('Record a Purchase') ?></h2>
        ...
        <form action="/boutique/achats/store" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <label for="article_id" class="block text-gray-700 text-sm font-bold mb-2"><?= _('Article') ?></label>
                    <select name="article_id" id="article_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" required>
                        <option value=""><?= _('-- Choose an article --') ?></option>
                ...
                <div>
                    <label for="quantite" class="block text-gray-700 text-sm font-bold mb-2"><?= _('Quantity') ?></label>
            ...
            <div class="mt-8 flex justify-end gap-4">
                <a href="/boutique/achats?eleve_id=<?= $eleve['id_eleve'] ?>" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded"><?= _('Cancel') ?></a>
