...
$navItems = [
    ...
    [
        ...
        'submenu' => [
            [
                'url' => '/presences/dashboard',
                'text' => _('Présences & Absences'),
                'title' => _('Accéder au hub opérationnel des présences, absences et retards.'),
                'condition' => Auth::can('view_all', 'presence') || Auth::can('manage', 'presence') || Auth::can('view', 'presence'),
            ],
            [
            ...
            [
                'url' => '/discipline/sanctions',
                'text' => _('Sanctions Disciplinaires'),
                'title' => _('Consulter et prononcer les sanctions disciplinaires des élèves.'),
                'condition' => Auth::can('view_sanctions', 'discipline'),
            ],
            [
                'url' => '/inscriptions',
                'text' => _('Inscriptions'),
    ...
    [
        ...
        'submenu' => [
            ...
            [
                ...
                'title' => _('Accéder au hub central des notes, évaluations, saisie, paramètres et bulletins.'),
                'condition' => Auth::can('view_all', 'note') || Auth::can('create_own', 'note') || Auth::can('manage_settings', 'evaluation') || Auth::can('generate', 'bulletin') || Auth::can('validate', 'bulletin') || Auth::can('print', 'bulletin') || Auth::can('edit_appreciation_conseil', 'bulletin'),
            ],
        ],
    ],
    [
    ...
    [
        ...
        'is_dropdown' => true,
        'condition' => Auth::can('view', 'paiement') || Auth::can('manage', 'paiement') || Auth::can('view', 'depense') || Auth::can('create', 'depense') || Auth::can('validate', 'depense') || Auth::can('pay', 'depense') || Auth::can('manage', 'depense') || Auth::can('view', 'sessions_caisse') || Auth::can('create', 'sessions_caisse') || Auth::can('edit', 'sessions_caisse') || Auth::can('validate', 'sessions_caisse') || Auth::can('view', 'comptes_financiers') || Auth::can('view', 'comptabilite') || Auth::can('view', 'budget') || Auth::can('report', 'budget') || Auth::can('adjust', 'budget') || Auth::can('view', 'comptes_comptables') || Auth::can('view', 'journal') || Auth::can('view_policy', 'finance') || Auth::can('edit_policy', 'finance') || Auth::can('view_control', 'finance') || Auth::can('view_reports', 'finance') || Auth::can('view', 'reporting') || Auth::can('manage', 'frais'),
        'submenu' => [
            [
                'url' => '/paiements',
