...
class ParametresGeneraux {
    ...
    public static function save($data) {
        ...
        $sql = $existing
            ? "UPDATE parametres_generaux SET nom_lycee = :nom_lycee, type_lycee = :type_lycee, annee_academique_id = :annee_academique_id, nombre_devoirs_par_trimestre = :nombre_devoirs_par_trimestre, modalite_paiement = :modalite_paiement, multilingue_actif = :multilingue_actif, biometrie_actif = :biometrie_actif, confidentialite_nationale = :confidentialite_nationale WHERE lycee_id = :lycee_id"
            : "INSERT INTO parametres_generaux (lycee_id, nom_lycee, type_lycee, annee_academique_id, nombre_devoirs_par_trimestre, modalite_paiement, multilingue_actif, biometrie_actif, confidentialite_nationale) VALUES (:lycee_id, :nom_lycee, :type_lycee, :annee_academique_id, :nombre_devoirs_par_trimestre, :modalite_paiement, :multilingue_actif, :biometrie_actif, :confidentialite_nationale)";
