...
try {
    ...
    // --- PHASE ADD VALIDATION FIELDS TO BULLETINS ---
    ...
    // --- PHASE DISCIPLINE PHASE 4 (HISTORIQUE, DOCUMENTS, NOTIFICATIONS) ---
    require_once __DIR__ . '/db/migrations/20240115_26_create_discipline_phase4_tables.php';
    migrate_26($db);
